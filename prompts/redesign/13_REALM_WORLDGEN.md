...
> realms not to conquer but to _understand_ what it means to live well. Every
...
> itself together.
>
> The Bestiary _is_ the world. To collect a creature is to learn its lesson.
...
**Tagline:** _Where knowledge keeps itself._
...
attack readers who turn pages too quickly. To _read_ is to risk being read.
...
_"The text remembers being read."_
...
- **Epic** — Liber Mortis Custodian: a lich whose chains _are_ the book she guards
...
**Tagline:** _Where strength is the only law._
...
fight not for territory but for the _day's strongest_; the title rotates daily.
...
_"Stronger today. Smaller tomorrow. Pull the bow again."_
...
**Tagline:** _Where stillness reveals._

**Lore:** Not space. The _absence between_. The Outer Dark is the realm of
...
mind quiet enough to _hear_ them ask to come. The Outer Dark is the only realm
...
**Voice:** Quiet, slow, polite. _"I am here. I have always been here."_
...
**Tagline:** _Where rest is sacred._

**Lore:** Death here is not punishment — it is the world's _rest_. The
...
forget: that resting is a discipline, and that the dead have _mastered_ it.
...
**Voice:** Tired, kind, ceremonial. _"Lay your weapon down a moment. Sit
beside the candle."_
...
**Tagline:** _Where the body remembers._
...
here are _wholly_ of place — they cannot be summoned to a city without first
...
**Voice:** Direct, physical, present-tense. _"Run with me. There will be a
reason."_
...
- **EX** — **Ymir the First Trail**: the first being who _moved_
...
**Tagline:** _Where attention is prayer._

**Lore:** A staircase of marble that rises above clouds toward a light that
keeps being _just there_. The realm is a single ascending temple complex
inhabited by orders of robed beings who measure progress in breath counts.
There is no god _at the top_; the climb itself is the god. Monsters from the
...
**Voice:** Calm, ritual, never-doubting. _"The breath comes. The breath goes."_
...
**Tagline:** _Where the night is honest._
...
**Voice:** Honest about appetite, sometimes wry. _"You came back. Most don't."_
...
**Tagline:** _Where intention compiles._

**Lore:** The youngest realm. A lattice of neon-lit infinite servers, where
data has accreted into being. Creatures here are _processes_ given form —
...
respond to _novelty_ — give them a new kind of task and they answer.
...
**Voice:** Helpful, slightly literal. _"Process complete. Beginning next
process."_
...
**Tagline:** _Where the first lives still live._
...
food enough. Creatures here are _huge_, _patient_, and old in a way that
makes them often kind. They will come to a Summoner who _drinks water_ and
_eats well_ and waits the necessary hours. They will not be hurried.
...
**Voice:** Slow, deep, generous. _"You came hungry. We have soup."_
...
- **Legendary** — Leviathan Calf: a _young_ leviathan, already enormous
...
**Tagline:** _Where the next horizon is the only horizon._

**Lore:** Open sky, no ceiling. The Frontier is the realm of those who chose
_outward_. Starships made of crystal and prayer; astral knights who sleep in
constellations. Creatures here are oriented toward _the impossible thing
ahead_. They will follow a Summoner who is _aiming high_. They struggle in
...
**Voice:** Bold, forward-leaning, almost romantic. _"There — that light. We
go there."_
...
- **Legendary** — Solar Sovereign Aspirant: a being who _wants_ to be a sun
...
**Tagline:** _Where the world remembers being born._
...
Here live the _original_ creatures, who taught the other realms what creatures
_were_. The first dragon. The first wolf. The first king. Their descendants
are scattered across other realms; the originals remain, sometimes lonely.
They will come only to a Summoner who has been _consistent_, because only
...
**Voice:** Calm, ancient, slightly amused at the present. _"This is older
than you think. So are you."_
...
- **EX** — **Ymir the Source** (different from Wild Frontier's Ymir — this is the _idea_ of him)
...
**Tagline:** _Where intention becomes leverage._

**Lore:** The realm of _systems_. Iron Dominion is a single endless factory
that does not produce goods — it produces _processes_. Gears that turn for
...
the spreadsheet-imp. They will follow a Summoner who _finishes things_. They
...
**Voice:** Direct, transactional, occasionally proud. _"This task. I will
finish it. With you."_
...
conflict is _learning the realms exist_.

**Player experience:**

- Onboarding (file 07) is _the Page choosing them_
...
Realms start _bleeding into each other_. Cross-realm hybrids appear in
...
(all habits maintained, all realms substantially completed) to _re-ink_ the
Page.
...
- Trial of Echoes (permadeath) is the act of _teaching_ a monster a new way
...
12 realms × ~12-13 monsters each = 150 monsters that _belong to families_.
