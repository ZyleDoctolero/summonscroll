...
export const RARITY_ORDER: Record<Rarity, number> = {
  common: 0, uncommon: 1, rare: 2, elite: 3,
  epic: 4, legendary: 5, mythic: 6, ex: 7,
};
...
export const PULL_RATES: Record<BannerType, Record<Rarity, number>> = {
  ...
  streak:    { common: 0.25, uncommon: 0.20, rare: 0.30, elite: 0.16, epic: 0.07, legendary: 0.015, mythic: 0.004, ex: 0.001 },
