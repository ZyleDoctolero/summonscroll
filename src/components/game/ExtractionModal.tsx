...
export function ExtractionModal({
  ...
  const getRarityGlow = () => {
    switch (monsterRarity) {
      case 'ex': return 'shadow-[0_0_40px_rgba(255,0,60,0.8)] border-red-500';
      case 'mythic': return 'shadow-[0_0_30px_rgba(255,215,0,0.6)] border-yellow-400';
      case 'legendary': return 'shadow-[0_0_20px_rgba(255,165,0,0.5)] border-orange-400';
      default: return 'shadow-[0_0_15px_rgba(168,85,247,0.5)] border-purple-500';
    }
  };
                  ...
                  >
                    <Input
                      ...
                      className={`text-center font-mono text-xl tracking-widest bg-black/50 border-cyan-500/50 text-cyan-100 placeholder:text-cyan-800/50 ${
                        isError ? 'border-red-500 text-red-400 focus-visible:ring-red-500' : 'focus-visible:ring-cyan-500'
                      }`}
                      autoFocus
                    />
                  </motion.div>
