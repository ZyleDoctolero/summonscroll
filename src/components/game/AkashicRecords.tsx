  ...
  return (
    <div className="relative w-full max-w-md mx-auto aspect-square bg-[#0a0f1e]/50 rounded-full border border-cyan-500/20 shadow-[inset_0_0_50px_rgba(0,240,255,0.05)] overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
        <motion.div 
          animate={canSynthesize ? { scale: [1, 1.1, 1], boxShadow: ["0 0 20px #00f0ff", "0 0 40px #00f0ff", "0 0 20px #00f0ff"] } : {}}
      ...
      {requiredFodder.map((fodder, index) => {
        ...
        return (
          ...
          >
            <div className={`w-12 h-12 rounded-full border-2 flex items-center justify-center bg-black/90 z-10 transition-colors ${
              fodder.isAvailable ? 'border-cyan-500 shadow-[0_0_15px_rgba(0,240,255,0.4)]' : 'border-slate-800'
            }`}>
