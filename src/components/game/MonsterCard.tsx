  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          r !== "common"
            ? `0 0 10px ${RARITY_COLOR[r]}30, inset 0 0 20px ${RARITY_COLOR[r]}10`
            : undefined,
    ...
    >
      ...
      <div className="absolute top-1.5 left-2 right-2 flex justify-between items-start z-10 pointer-events-none">
          ...
          <div className="flex mt-0.5">
            {Array.from({
              ...
              <Icon
                ...
                style={{ filter: `drop-shadow(0 0 2px ${RARITY_COLOR[r]})` }}
              />
            ))}
          </div>
        </div>
        ...
        <div className="flex flex-col items-end">
          <span
            ...
            style={{ color: "var(--ink-primary)", textShadow: "0 0 4px var(--cyan)" }}
          >
            Lv.{monster.level}
          </span>
          {ascensionLevel > 0 && (
            <span
              className="font-['VT323'] text-sm leading-none mt-0.5 text-fuchsia-400"
              style={{ textShadow: "0 0 4px #d500f9" }}
            >
              +{ascensionLevel}
            </span>
          )}
          ...
          style={{
            filter:
              monster.bond_percent >= 100
                ? `drop-shadow(0 0 8px ${RARITY_COLOR[r]}) contrast(1.15)`
                : fatigued
                  ? "grayscale(100%) opacity(50%)"
                  : "drop-shadow(0 0 4px rgba(255,255,255,0.1)) contrast(1.05)",
          }}
      ...
      <div className="flex flex-col gap-1 relative z-10 bg-[#050a14]/80 p-1.5 rounded border border-white/5 backdrop-blur-sm">
        <p
          ...
          style={{ color: "var(--ink-primary)", textShadow: "0 0 3px var(--cyan)" }}
        >
