...
const FireSprite = () => (
  <svg width="100%" height="100%" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M76,62 Q90,48 84,38 Q80,30 72,36"
      stroke="#ff5e2a"
      strokeWidth="5"
      fill="none"
      strokeLinecap="round"
...
const getElementSprite = (el: string) => {
  switch (el?.toLowerCase()) {
    ...
    case "dark":
      return <DarkSprite />;
    default:
      return <DarkSprite />; // Void/fallback
  }
};
...
const getRarityBackground = (r: Rarity) => {
  switch (r) {
    case "common":
      return "linear-gradient(155deg,#f5efe6,#ede5d8)";
    case "uncommon":
      return "linear-gradient(155deg,#eef5ec,#e4eddf)";
    case "rare":
      return "linear-gradient(155deg,#e8eef5,#dce6f0)";
    case "elite":
      return "linear-gradient(155deg,#f5f0e6,#ede4d2)";
    case "epic":
      return "linear-gradient(155deg,#efe8f5,#e6dcf0)";
    case "legendary":
      return "linear-gradient(155deg,#f5efe2,#ede5cc)";
    case "mythic":
      return "linear-gradient(155deg,#f5e8e2,#f0dcd4)";
    default:
      return "linear-gradient(155deg,#f5efe6,rgba(240,230,215,0.8))";
  }
};
...
const getRarityBorder = (r: Rarity, rColor: string) => {
  switch (r) {
    case "common":
      return { width: "1.5px", style: `1.5px solid ${rColor}40`, shadow: `0 4px 16px ${rColor}15` };
    case "uncommon":
      return { width: "1.5px", style: `1.5px solid ${rColor}55`, shadow: `0 4px 20px ${rColor}20` };
    case "rare":
      return {
        width: "2px",
        style: `2px solid ${rColor}70`,
        shadow: `0 4px 24px ${rColor}30, inset 0 0 20px ${rColor}08`,
      };
    case "elite":
      return {
        width: "2px",
        style: `2px solid ${rColor}80`,
        shadow: `0 6px 28px ${rColor}35, inset 0 0 24px ${rColor}10`,
      };
    case "epic":
      return {
        width: "2.5px",
        style: `2.5px solid ${rColor}90`,
        shadow: `0 6px 32px ${rColor}40, 0 0 16px ${rColor}25, inset 0 0 28px ${rColor}12`,
      };
    case "legendary":
      return {
        width: "3px",
        style: `3px solid ${rColor}`,
        shadow: `0 8px 36px ${rColor}50, 0 0 24px ${rColor}35, inset 0 0 32px ${rColor}15`,
      };
    case "mythic":
      return {
        width: "3px",
        style: `3px solid ${rColor}`,
        shadow: `0 8px 40px ${rColor}60, 0 0 32px ${rColor}40, inset 0 0 40px ${rColor}18`,
      };
    default:
      return { width: "1.5px", style: `1.5px solid ${rColor}40`, shadow: `0 4px 16px ${rColor}15` };
  }
      ...
      >
        ...
        {isDormant && (
          <div className="ss-monster-dormant-overlay">
            ...
            <span
              className="px-font"
              style={{ fontSize: 9, color: "#888", textTransform: "uppercase" }}
            >
              Dormant
            </span>
          </div>
        ...
        <div className="flex flex-col gap-1 relative z-10 mt-3">
          ...
          <div className="flex justify-between items-center mt-0.5">
            <span className="px-font text-[9px] uppercase" style={{ color: "var(--ink-tertiary)" }}>
              Bond
            </span>
            <span
              className="px-font text-[9px]"
              style={{ color: isSoulBound ? "#c47fff" : elColor }}
            >
        ...
        {fatigued && !isDormant && (
          <div className="ss-badge-dormant mt-2 w-full justify-center">FADING — needs care</div>
        )}
