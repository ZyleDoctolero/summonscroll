...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          equip_weapon_id: string | null;
          equip_armor_id: string | null;
          equip_mount_id: string | null;
          gold: number;
          hp: number;
          id: string;
          in_penalty_zone: boolean;
          int_stat: number;
          island_last_harvest_at: string;
          island_pending_gold: number;
          ...
          soul_fragments: Json;
          soul_load_current: number;
          soul_load_max: number;
    ...
    Functions: {
      ascend_monster: {
        Args: { p_base_id?: string; p_material_id?: string; p_user_monster_id?: string };
        Returns: Json;
      };
      bind_companion: {
        Args: { p_slot: string; p_monster_id: string | null };
        Returns: Json;
      };
      claim_expedition: {
      ...
      evolve_monster: {
        Args: {
          p_base_id: string;
          p_recipe_id: string;
          p_catalyst_name: string;
          p_result_name: string;
        };
        Returns: Json;
      };
      ...
      resolve_battle_turn: {
        Args: { p_battle_id: string; p_choice: string };
        Returns: Json;
      };
      pull_banner: {
    ...
    Enums: {
      ...
      task_event_kind: "plus" | "minus" | "complete" | "uncomplete" | "miss" | "cron_drift";
...
export const Constants = {
  ...
  public: {
    Enums: {
      ...
      goal_type: ["quarterly", "monthly", "weekly"],
      guild_role: ["leader", "officer", "member"],
      monster_rarity: ["common", "uncommon", "rare", "elite", "epic", "legendary", "mythic", "ex"],
      monster_role: ["attacker", "tank", "healer", "support", "debuffer"],
      player_class: ["none", "warrior", "mage", "rogue", "healer"],
      pull_currency: ["gems", "pact_seals"],
      quest_status: ["pending", "active", "completed", "failed"],
